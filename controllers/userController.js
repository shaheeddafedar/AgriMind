...
exports.getProfileData = async (req) => {
    const user = await User.findById(req.session.user._id);
...
exports.downloadSingleReport = async (req, res) => {
    try {
        ...
        res.setHeader(
            'Content-Disposition',
            `attachment; filename=AgriMind_Report_${rec.recommendedCrop}.pdf`
        );
        ...
        doc
            ...
            .fontSize(12)
            .text(
                'Based on your inputs, the AI recommends:',
                70,
                210
            );
        ...
        doc
            ...
            .font('Helvetica-Bold')
            .text(
                rec.recommendedCrop.toUpperCase(),
                70,
                235
            );
